...
class AnalysisContext:
    ...
    depth: AnalysisDepth
    intent_reasoning: str = ""  # Intent Agent의 reasoning
    analysis_reasoning: str = ""  # Intent Agent의 analysis_reasoning
    additional_reasoning: str = ""  # _determine_additional_agents의 reasoning
